#!/bin/bash
# Autonomy Mode v2 — Execute a plan (native Claude Code TUI)
# Usage: ./scripts/autonomy-v2.sh [PLAN_FILE]
# Default: PLAN.md
#
# Env vars:
...
echo "Launching autonomy mode v2 (native TUI): execute $PLAN_FILE"
